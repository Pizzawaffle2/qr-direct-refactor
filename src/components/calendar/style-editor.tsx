    ...
    <div className="space-y-6">
      <Tabs activeTab={activeTab} onChange={setActiveTab} tabs={TABS}>
        <TabContent tabId="colors" activeTab={activeTab}>
          <Card className="p-4 bg-[rgb(var(--card))] dark:bg-[rgb(var(--card))]">
            <div className="space-y-4">
              <h3 className="font-medium text-[rgb(var(--text))] dark:text-[rgb(var(--foreground))]">Color Settings</h3>

              {Object.entries(value.theme?.colors ?? {}).map(([key, color]) => (
                <div key={key} className="grid gap-2">
                  <Label className="capitalize text-[rgb(var(--text))] dark:text-[rgb(var(--foreground))]">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Input
                      ...
                      className="flex-1 bg-[rgb(var(--input))] dark:bg-[rgb(var(--input))]"
        ...
        <TabContent tabId="layout" activeTab={activeTab}>
          <Card className="p-4 bg-[rgb(var(--card))] dark:bg-[rgb(var(--card))]">
            <div className="space-y-4">
              <h3 className="font-medium text-[rgb(var(--text))] dark:text-[rgb(var(--foreground))]">Layout Settings</h3>

              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="text-[rgb(var(--text))] dark:text-[rgb(var(--foreground))]">First Day of Week</Label>
                  ...
                  <Select
                    ...
                    onValueChange={(val: '0' | '1') => updateValue(['firstDayOfWeek'], val)}
                  >
                    <SelectTrigger className="w-32 bg-[rgb(var(--input))] dark:bg-[rgb(var(--input))]">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <Label className="text-[rgb(var(--text))] dark:text-[rgb(var(--foreground))]">Week Numbers</Label>
                    <p className="text-sm text-[rgb(var(--muted-foreground))] dark:text-[rgb(var(--foreground))]">
                      Show week numbers
                    </p>
                  </div>
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) => updateValue(['showWeekNumbers'], checked)}
                  />
                </div>

                <div className="flex items-center justify-between">
                  <div>
                    <Label className="text-[rgb(var(--text))] dark:text-[rgb(var(--foreground))]">Months per Row</Label>
                    <p className="text-sm text-[rgb(var(--muted-foreground))] dark:text-[rgb(var(--foreground))]">
                  ...
                  <Select
                    ...
                    onValueChange={(val) => updateValue(['monthsPerRow'], parseInt(val))}
                  >
                    <SelectTrigger className="w-32 bg-[rgb(var(--input))] dark:bg-[rgb(var(--input))]">
                      <SelectValue />
                    </SelectTrigger>
        ...
        <TabContent tabId="features" activeTab={activeTab}>
          <Card className="p-4 bg-[rgb(var(--card))] dark:bg-[rgb(var(--card))]">
            <div className="space-y-4">
              <h3 className="font-medium text-[rgb(var(--text))] dark:text-[rgb(var(--foreground))]">Features</h3>
              ...
              {[
                ...
                { key: 'showNotes', label: 'Notes', description: 'Enable note taking' },
              ].map(({ key, label, description }) => (
                <div key={key} className="flex items-center justify-between">
                  <div>
                    <Label className="text-[rgb(var(--text))] dark:text-[rgb(var(--foreground))]">{label}</Label>
                    <p className="text-sm text-[rgb(var(--muted-foreground))] dark:text-[rgb(var(--foreground))]">
                      {description}
                    </p>
                  </div>
                  <Switch
                    ...
                    onCheckedChange={(checked: boolean) => handleOptionChange(key, checked)}
                  />
                </div>
              ))}
            </div>
